#ifndef IO_NCHILADA_FILE_DEF_H
#define IO_NCHILADA_FILE_DEF_H

/**
 * \file io_nchilada_file_def.h
 *
 * Provides the structure definition for the field NCHILADA file structure.
 *     (e.g. gas/pos, star/vel, etc.)
 */
...
/**
 * The file structure itself.  an array of structs within io_nchilada_struct
 */
struct io_nchilada_file_struct {
	...
	/** NCHILADA version TODO what options are there? */
	int8_t ver;
	/** NCHILADA header size */
	int32_t headsize;
...
/** Convenient typedef */
typedef struct io_nchilada_file_struct io_nchilada_file_struct_t;

/** Convenient typedef */
typedef io_nchilada_file_struct_t *io_nchilada_file_t;


#endif /* IO_NCHILADA_FILE_DEF_H */
