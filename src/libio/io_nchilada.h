#ifndef IO_NCHILADA_H
#define IO_NCHILADA_H
...
/**                          
 * \brief Reads from an opened NCHILADA file all particle information and
 *        converts them to AMIGA units.
 *
 * This functions requires the file object to be opened by
 * io_nchilada_open and inititalized by io_amiga_init. It also requires
...
/**                          
 * \brief Reads from an opened NCHILADA file all particle information
 *        without converting to AMIGA units.
 *
 * Otherwise the io_nchilada_readpart();
 *
 * \param log    The logging object.
 * \param f      The initialized file object.
 * \param pskip  Number of particles to skip.
...
/**
 * \brief Writes the particles to a NCHILADA binary file
 *
...
/**
 * \brief Writes the particles to a NCHILADA binary file in an ordered
 *        way.
 *
 * The file object given to the function needs to be opened for
 * writing.
 ...
 * \param log          The logging object.
 * \param f            The file object.
 * \param posscale     The new scale to translate from NCHILADA file
 *                     units to Mpc.
 * \param weightscale  The new scale to translate from NCHILADA file units
 *                     to Msun.
 */
extern void
